      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="swiper init-swiper">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide" style="background-image: url('{{asset('assets/frontend/img/post-slide-1.jpg')}}');">
              <div class="content">
            ...
            <div class="swiper-slide" style="background-image: url('{{asset('assets/frontend/img/post-slide-2.jpg')}}');">
              <div class="content">
            ...
            <div class="swiper-slide" style="background-image: url('{{asset('assets/frontend/img/post-slide-3.jpg')}}');">
              <div class="content">
            ...
            <div class="swiper-slide" style="background-image: url('{{asset('assets/frontend/img/post-slide-4.jpg')}}');">
              <div class="content">
          ...
          <div class="row g-5">
            <div class="col-lg-4">
              ...
              <div class="post-entry lg">
                <a href="blog-details.html"><img src="{{asset('assets/frontend/img/post-landscape-1.jpg') }}" alt="" class="img-fluid"></a>
                ...
                <div class="d-flex align-items-center author">
                  <div class="photo"><img src="{{asset('assets/frontend/img/person-1.jpg') }}" alt="" class="img-fluid"></div>
                  <div class="name">
              ...
              <div class="row g-5">
                <div class="col-lg-4 border-start custom-border">
                  <div class="post-entry">
                    <a href="blog-details.html"><img src="{{asset('assets/frontend/img/post-landscape-2.jpg') }}" alt="" class="img-fluid"></a>
                  ...
                  <div class="post-entry">
                    <a href="blog-details.html"><img src="{{asset('assets/frontend/img/post-landscape-5.jpg') }}" alt="" class="img-fluid"></a>
                  ...
                  <div class="post-entry">
                    <a href="blog-details.html"><img src="{{asset('assets/frontend/img/post-landscape-7.jpg') }}" alt="" class="img-fluid"></a>
                ...
                <div class="col-lg-4 border-start custom-border">
                  <div class="post-entry">
                    <a href="blog-details.html"><img src="{{asset('assets/frontend/img/post-landscape-3.jpg') }}" alt="" class="img-fluid"></a>
                  ...
                  <div class="post-entry">
                    <a href="blog-details.html"><img src="{{asset('assets/frontend/img/post-landscape-6.jpg') }}" alt="" class="img-fluid"></a>
                  ...
                  <div class="post-entry">
                    <a href="blog-details.html"><img src="{{asset('assets/frontend/img/post-landscape-8.jpg') }}" alt="" class="img-fluid"></a>
          ...
          <div class="col-md-9">
            ...
            <div class="d-lg-flex post-entry">
              ...
              <div>
                ...
                <div class="d-flex align-items-center author">
                  <div class="photo"><img src="{{asset('assets/frontend/img/person-2.jpg') }}" alt="" class="img-fluid"></div>
                  <div class="name">
          ...
          <div class="col-md-9 order-md-2">
            ...
            <div class="d-lg-flex post-entry">
              ...
              <div>
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat exercitationem magni voluptates dolore. Tenetur fugiat voluptates quas, nobis error deserunt aliquam temporibus sapiente, laudantium dolorum itaque libero eos deleniti?</p>
                <div class="d-flex align-items-center author">
                  <div class="photo"><img src="{{asset('assets/frontend/img/person-4.jpg') }}" alt="" class="img-fluid"></div>
                  <div class="name">
                    <h3 class="m-0 p-0">Wade Warren</h3>
                  </div>
                </div>
        ...
        <div class="row g-5">
          <div class="col-lg-4">
            <div class="post-list lg">
              ...
              <div class="d-flex align-items-center author">
                <div class="photo"><img src="{{asset('assets/frontend/img/person-7.jpg') }}" alt="" class="img-fluid"></div>
                <div class="name">
          ...
          <div class="col-lg-8">
            <div class="row g-5">
              <div class="col-lg-4 border-start custom-border">
                ...
                <div class="post-list">
                  <a href="blog-details.html"><img src="{{asset('assets/frontend/img/post-landscape-4.jpg') }}" alt="" class="img-fluid"></a>
